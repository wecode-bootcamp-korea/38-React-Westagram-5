      ...
      <div className="article">
        <div className="feedWrap">
          <div className="account">
            <img src="/Users/hyun/Desktop/38-React-Westagram-5/src/assets/images/choihyun/profile-insta.jpeg" className="profile" />
            <h3>hyun._.gus</h3>
          </div>
          <div className="dot">
            <h2>…</h2>
        ...
        <div className="imgWrap">
          <img src="/Users/hyun/Desktop/38-React-Westagram-5/src/assets/images/choihyun/7stars-insta.jpeg" />
        </div>
        ...
        <div className="comment">
          ...
          <input className="commentInput" placeholder="댓글을 입력하세요..." 
    ...
    <div className="main-right">
      ...
      <div className="storyWrap">
        ...
        <div className="userWrap">
          <div className="userN">
            <img src="/Users/hyun/Desktop/38-React-Westagram-5/src/assets/images/choihyun/user1.jpeg" className="rightProfile" alt="user1" />
          ...
          <div className="userN">
            <img src="/Users/hyun/Desktop/38-React-Westagram-5/src/assets/images/choihyun/user2.jpeg" className="rightProfile" alt="user1" />
            <div className="userIdTime">
              <h4>yougettheswag</h4>
              <p>16분 전</p>
            </div>
          ...
          <div className="userN">
            <img src="/Users/hyun/Desktop/38-React-Westagram-5/src/assets/images/choihyun/user3.jpeg" className="rightProfile" alt="user1" />
            <div className="userIdTime">
